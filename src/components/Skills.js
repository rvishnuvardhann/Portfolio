...
import {SiJavascript,SiGit,SiNodedotjs,SiFlutter,SiReact,SiHtml5,SiCss3,SiMysql,SiMongodb,SiExpress,SiPython} from 'react-icons/si'
function Skills() {
  return (
    <Fragment>
                    ...
                    <div className="col-lg-6 col-md-12 col-sm-12 d-flex align-items-center">
                        <div>
                            ...
                            <div className="row my-2">
                                ...
                                <div className='mx-2 my-3 border rounded py-1 px-2 mw-fc'>
                                    <span><SiFlutter className='fs-4'/> Flutter</span>
                                </div>
                                <div className='mx-2 my-3 border rounded py-1 px-2 mw-fc'>
